...
public class EchoClient {
    ...
    public static String getString(String prompt) throws Exception { // 键盘信息 输入
    ...
    public static void main(String[] args) throws Exception {
        ...
        scan.useDelimiter("\n");
        PrintStream out = new PrintStream(client.getOutputStream()); // 向服务器端发 送内容
        boolean flag = true;           // 循环标记
        while (flag) {            // 循环处理
            String input = getString("请输入要发送的内容：").trim();  // 获取键盘 输入数据
